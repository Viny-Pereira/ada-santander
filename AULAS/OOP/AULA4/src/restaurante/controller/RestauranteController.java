...
public class RestauranteController {
    ...
    private void fazerPedido() {
        System.out.println("Já existe um cliente para este pedido? (S/N)");
        ...
        if (opcao.equalsIgnoreCase("S")) {
            ...
            System.out.println("Deseja cadastrar um novo cliente com este pedido? (S/N): ");
        ...
        while (true) {
            ...
            scanner.nextLine();
            if (opcaoPrato == 1) {
                System.out.println("Identificador do Prato");
        ...
        clienteService.fazerPedido(cliente.getNomeCliente(), cliente.getIdentificadorCliente(),
                nomeRestaurante, identificadorRestaurante, pratos, endereco);
    ...
    private void listarPedidosRestaurante() {
        ...
        List<Pedido> pedidos = restauranteService.listarPedidosRestaurante(nome, identificadorRestaurante);
    ...
    private void verPedidosCliente() {
        ...
        System.out.println("Nome do cliente");
        nomeCliente = scanner.next();
        List<Pedido> pedidos = clienteService.verPedidosClientes(nomeCliente, identificadorCliente);
        if (pedidos == null || pedidos.isEmpty()) {
