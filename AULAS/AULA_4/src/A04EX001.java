...
public class A04EX001 {
    ...
    public static double[] custosCarro(double[] input) {
        double[] custos = new double[2];
        double valorDistribuidor = input[1]/input[0]*100;
        double valorImpostos = input[2]/input[0]*100;
        custos[0]=arredondar(valorDistribuidor);
        custos[1]=arredondar(valorImpostos);
        return custos;
    }
